...
let
  emailCloudflareRouting = [
    (MX { name = "@"; priority = 99; target = "route1.mx.cloudflare.net."; ttl = 1; })
    (MX { name = "@"; priority = 69; target = "route2.mx.cloudflare.net."; ttl = 1; })
    (MX { name = "@"; priority = 9; target = "route3.mx.cloudflare.net."; ttl = 1; })
