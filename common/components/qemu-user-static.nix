...
let
  ...
  qemu-user-static = {
    ...
    qemu-hexagon-static = {
      interpreter = "${pkgs.nur.repos.xddxdd.qemu-user-static}/bin/qemu-hexagon-static";
    ...
    qemu-i386-static = {
      ...
      interpreter = "${pkgs.nur.repos.xddxdd.qemu-user-static}/bin/qemu-i386-static";
    ...
    qemu-microblazeel-static = {
      interpreter = "${pkgs.nur.repos.xddxdd.qemu-user-static}/bin/qemu-microblazeel-static";
    ...
    qemu-or1k-static = {
      interpreter = "${pkgs.nur.repos.xddxdd.qemu-user-static}/bin/qemu-or1k-static";
