{ config, inputs, ... }:
{
  ...
  services.dn42 = {
    ...
    duststar = {
      remoteASN = 4242421771;
      latencyMs = 1;
      peering.mpbgp = true;
      tunnel = {
        type = "wireguard";
        localPort = 21771;
        remoteAddress = "148.135.56.215";
        remotePort = 32593;
        wireguardPubkey = "EICoXACqRyO8ngWBPc4aOnh5eiDsa6AIZ0vMdlF4Xx4=";
      };
      addressing = {
        peerIPv6LinkLocal = "fe80::afaf:bfbf:cdcf:2a";
      };
    };
    emerald = {
    ...
    potat0 = {
      ...
      tunnel = {
        type = "wireguard";
        localPort = 21816;
        remoteAddress = "las.node.potat0.cc";
        remotePort = 22547;
