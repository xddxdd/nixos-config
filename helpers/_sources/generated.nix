...
}:
{
  ...
  delegacy-rpz = {
    pname = "delegacy-rpz";
    version = "effc91551695f92b9cf0d7c4fc6dd0e939d20e2c";
    src = fetchgit {
      url = "https://codeberg.org/IPv6-Monostack/delegacy-rpz.git";
      rev = "effc91551695f92b9cf0d7c4fc6dd0e939d20e2c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-1MBwPFzdExCGSiToXYDPeLNGbcu0oA8Cck82MYi1bzc=";
    };
    date = "2025-10-10";
  };
  ...
  lobe-icons = {
    pname = "lobe-icons";
    version = "9bcd8b152a0cd1469094f8f145fdd820787bd828";
    src = fetchgit {
      url = "https://github.com/lobehub/lobe-icons.git";
      rev = "9bcd8b152a0cd1469094f8f145fdd820787bd828";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-nFCCrWBUxXztWoTPoLOLs25eJMmwlWS7GBDD8G5DBhU=";
    };
    date = "2025-10-10";
  };
  mihoyo-bbs-tools = {
