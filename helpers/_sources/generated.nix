...
}:
{
  bosl2 = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-sBbHmRl6NNKbd/tOSMs/B6XX0REP4tYqqCGx3Rc4ZEc=";
    };
  };
  delegacy-rpz = {
    pname = "delegacy-rpz";
    version = "a852706efa529d7bef2ef0b3331d963048650721";
    src = fetchgit {
      url = "https://codeberg.org/IPv6-Monostack/delegacy-rpz.git";
      rev = "a852706efa529d7bef2ef0b3331d963048650721";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-X5DFAclyfzA6hYUFirV0ImG0SvfOcBwnrOH1u9FN1yc=";
    };
    date = "2026-04-17";
  };
  ...
  lobe-icons = {
    pname = "lobe-icons";
    version = "933ef6711f32c47297f64f8395460c798b9bccad";
    src = fetchgit {
      url = "https://github.com/lobehub/lobe-icons.git";
      rev = "933ef6711f32c47297f64f8395460c798b9bccad";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-A6nU3QCdpeR8hlcQKAy6rN9Na5loh7erh6QLoprO4HE=";
    };
    date = "2026-04-21";
  };
  mihoyo-bbs-tools = {
