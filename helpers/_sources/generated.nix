...
}:
{
  auto-novel-addon = {
    ...
    version = "1.5.2";
    src = fetchurl {
      url = "https://github.com/auto-novel/addon/releases/download/v1.5.2/addon-1.5.2-firefox.xpi";
      sha256 = "sha256-pzQUZKCAzrEaZwwJEl/bAKN7SCG2gAIlN67veoMbwaI=";
    };
  };
  bosl2 = {
    pname = "bosl2";
  ...
  delegacy-rpz = {
    pname = "delegacy-rpz";
    version = "7480913085d50cd47a0a3e2ec29f1d7b24810166";
    src = fetchgit {
      url = "https://codeberg.org/IPv6-Monostack/delegacy-rpz.git";
      rev = "7480913085d50cd47a0a3e2ec29f1d7b24810166";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-7/aMPamumKoyXeFSro6ScTuIR6iuakgNNMHAJU1HWlw=";
    };
    date = "2026-05-15";
  };
  ...
  firefox-stealth = {
    ...
    src = fetchFromGitHub {
      ...
      fetchSubmodules = false;
      sha256 = "sha256-N3yoG/ZgCwVhur1uKX6KMEHilR5Xzmd9pvbMbpx0QHM=";
    };
    date = "2026-05-15";
  };
