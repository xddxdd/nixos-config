{
  ...
  addCommonLocationConf = {
    ...
    lib.recursiveUpdate (lib.optionalAttrs enable ({
  ...
  generatedVhostOptions =
    {
      ...
      extraConfig =
        ...
        '')
        + (lib.optionalString (config.enableCommonVhostOptions && (config.listenHTTPS.enable || config.listenHTTPS_Socket.enable)) ''
