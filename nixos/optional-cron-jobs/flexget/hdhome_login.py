...
username = os.environ["HDHOME_USER"]
password = os.environ["HDHOME_PASS"]

try:
    with open("hdhome.json") as f:
        j = json.load(f)
...
q = requests.post(
    ...
    json={
        "cmd": "request.post",
        "session": str(session_id),
        "url": "https://hdhome.org/takelogin.php",
