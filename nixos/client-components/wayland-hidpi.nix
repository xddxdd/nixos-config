...
let
  ...
  consoleFontSize =
    ...
    else if targetSize >= 23 then 24
    else if targetSize >= 21 then 22
    else if targetSize >= 19 then 20
    else if targetSize >= 17 then 18
    else if targetSize >= 15 then 16
    else if targetSize >= 13 then 14
    else 12;
in
{
